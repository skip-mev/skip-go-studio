  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto w-7xl flex h-screen">
          {/* Content goes here */}
          {/* Left Sidebar */}
          <div className="flex w-[472px] flex-col justify-between px-6 text-white relative">
            <div className="flex flex-col gap-2.5 overflow-y-scroll">
              ...
              <Card>
                <div className="flex flex-col gap-2">
                  ...
                  <p>
                    Select the chains and assets you want to support in the
                    widget
                  </p>
                </div>
